...
namespace kcp2k
{
    public class KcpServer
    {
        ...
        protected readonly Action<EndPoint> OnConnected;
        protected readonly Action<int, ArraySegment<byte>, KcpChannel> OnData;
        protected readonly Action<EndPoint> OnDisconnected;
        protected readonly Action<EndPoint, ErrorCode, string> OnError;
        ...
        public KcpServer(Action<EndPoint> OnConnected,
                         Action<int, ArraySegment<byte>, KcpChannel> OnData,
                         Action<EndPoint> OnDisconnected,
                         Action<EndPoint, ErrorCode, string> OnError,
                         KcpConfig config)
        {
        ...
        // public void Send(EndPoint connectionId, ArraySegment<byte> segment, KcpChannel channel)
        // {
        //     if (connections.TryGetValue(connectionId, out KcpServerConnection connection))
        //     {
        //         connection.peer.SendData(segment, channel);
        ...
        protected virtual KcpServerConnection CreateConnection(int connectionId, EndPoint connectionEndpoint)
        {
            ...
            void OnAuthenticatedWrap()
            {
                ...
                OnConnected(connectionEndpoint);
            }
            ...
            void OnDisconnectedWrap()
            {
                ...
                OnDisconnected(connectionEndpoint);
            }

            void OnErrorWrap(ErrorCode error, string reason)
            {
                OnError(connectionEndpoint, error, reason);
            }
        }
